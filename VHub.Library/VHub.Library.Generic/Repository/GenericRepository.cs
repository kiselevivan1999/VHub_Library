...
namespace VHub.Library.Generic.Repository;
...
internal abstract class GenericRepository<T> : IGenericRepository<T> where T : class
{
    ...
    /// </summary>
    /// <typeparam name="TPrimaryKey">Тип id</typeparam>
    /// <param name="id">Id сущности.</param>
    /// <returns>Cущность.</returns>
    public virtual T? Get<TPrimaryKey>(TPrimaryKey id)
    {
    ...
    /// <returns>Cущность. </returns>
    public virtual async Task<T?> GetAsync<TPrimaryKey>(TPrimaryKey id, CancellationToken cancellationToken)
    {
    ...
    public virtual bool Delete<TPrimaryKey>(TPrimaryKey id)
    {
